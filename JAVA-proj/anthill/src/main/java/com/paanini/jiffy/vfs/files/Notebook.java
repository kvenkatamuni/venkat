...
import com.option3.docube.schema.nodes.NotebookSchema;
...
public class Notebook extends NotebookSchema implements ExtraFileProps,
  ...
  public Notebook() {
    setType(Type.NOTEBOOK);
  }

  public Notebook(final SpecificRecordBase schema) {
    NotebookSchema ds = (NotebookSchema) schema;
